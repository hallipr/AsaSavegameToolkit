...
namespace AsaSavegameToolkit
{
    public class AsaGameObject
    {
        ...
        public AsaGameObject(AsaArchive archive)
        {
            ...
            string? bluePrintPath = archive.ReadString();
        ...
        public AsaGameObject(Guid newId, List<AsaProperty<dynamic>> properties)
        {
            ...
            if (classRef != null && classRef.Value != null)
            {
        ...
        {
            Guid = objectId;
            ClassName = archive.ReadName() ?? AsaName.NameNone;
            ...
            while (nameCount-- > 0)
            {
                ...
                {
                    Names.Add(archive.ReadName() ?? throw new Exception("Unexpected null result from ReadName"));
                }
