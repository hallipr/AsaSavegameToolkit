    ...
    public static class AsaPropertyRegistry
    {
        ...
        private static bool TryReadStructPropertyValue(AsaArchive archive, int dataSize, AsaName structType, bool inArray, [NotNullWhen(true)] out dynamic? value)
        {
            try
            {
                ...
                {
                    case "LinearColor":
                        value = archive.ReadLinearColor("value");
                        return true;
                        
                    case "Quat":
                        value = archive.ReadQuaternion("value");
                        return true;
                        
                    case "Vector":
                        value = archive.ReadVector("value");
                        return true;
                        
                    case "Rotator":
                        value = archive.ReadRotator("value");
                        return true;
